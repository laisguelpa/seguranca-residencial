...
<body>
    ...
    <div>
        ...
        <header>
          ...
          <div class="CcXDFilym5SZAD4RMvAdX">
            <div>
            <button class="botao" title="Entrar" type="button"><span class="span">Entrar</span></button>
            <button class="botao" title="Registre-se" type="button"><span class="span">Registre-se</span></button>
            </div>
          </div>
        </header>
